    ...
    $("seExportNow").addEventListener("click",async()=>{
      ...
      try{
        if($("seExportType").value==="structure"){
          ...
          const fmt=$("seImageFormat").value,scale=Number($("seImageScale").value)||2,bg=$("seImageBackground").value;
